...
def routing_analysis_arg_parser():
    parser = argparse.ArgumentParser()

    parser.add_argument("--model_name", type=str, default="microsoft/Phi-3-mini-4k-instruct")
    parser.add_argument("--language_experts", type=str, default="TahaBa/phi3-mini-general-adapters/cluster0_batch16_prop1.0_langen/checkpoint-16")
    parser.add_argument("--local_dir", type=str, default="model")
    parser.add_argument("--dataset_name", type=str, default="TahaBa/flan-routing-MoE-dataset")
    parser.add_argument("--hf_token", type=str, default="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")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--top-k", type=int, default=3)
    parser.add_argument("--router-temperature", type=float, default=1.0)
    parser.add_argument("--top_k_callback", type=int, default=3)
    parser.add_argument("--batch_size", type=int, default=1)
